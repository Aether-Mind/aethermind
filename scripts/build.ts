/**
 * AetherMind build script — bundles the TypeScript source into a single
...
const result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.PACKAGE_URL': JSON.stringify('@aethermind-ai/aethermind'),
...
if (!result.success) {
  ...
  console.log(`✓ Built aethermind v${version} → dist/cli.mjs`)
}
