...
export function createWhatsNewFeed(releaseNotes: string[]): FeedConfig {
  ...
  return {
    title: "external" === 'ant' ? "AetherMind Updates [internal-only: Latest CC commits]" : "AetherMind Updates",
    lines,
...
export function createGuestPassesFeed(): FeedConfig {
  ...
  const subtitle = reward ? `Share AetherMind and earn ${formatCreditAmount(reward)} of extra usage` : 'Share AetherMind with friends';
  return {
