 ...
 *
 * Usage:
 *   aethermind --provider openai --model gpt-4o
 *   aethermind --provider gemini --model gemini-2.0-flash
 *   aethermind --provider mistral --model ministral-3b-latest
 *   aethermind --provider ollama --model llama3.2
 *   aethermind --provider anthropic   (default, no-op)
 */
