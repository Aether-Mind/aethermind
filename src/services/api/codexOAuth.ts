...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to aethermind now.</p>
    <p>aethermind will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in aethermind.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in aethermind.</p>
  </body>
</html>`
}
