...
const PROTO_PATH = path.resolve(import.meta.dirname, '../proto/aethermind.proto')
...
const aethermindProto = protoDescriptor.aethermind.v1
...
export class GrpcServer {
  ...
  constructor() {
    ...
    this.server.addService(aethermindProto.AgentService.service, {
